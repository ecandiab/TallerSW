...
public interface ITomarReservaController extends IIdentificarReservaClienteController,
									   IHacerReservaController,
									   IModificarReservaController
{
	// Operations ---------------------------------------------------------------------------------

	List<ReservaDTO> buscarReservasPendientes(String nombreHotel) throws Exception;
	...
	default List<ReservaDTO> buscarReservasPendientes(HotelDTO hotel) throws Exception
	{
		return buscarReservasPendientes(hotel.getNombre());
	}
	
	@Override
	public default boolean confirmarDisponibilidad(HotelDTO hotel, TipoHabitacionDTO tipoHabitacion, GregorianCalendar fechaInicio, GregorianCalendar fechaFin) throws Exception
	{
	...
	{
		return registrarHuesped(huesped.getNombre(), huesped.getDocumento());
	}
	...
	@Override
	public default List<HotelDTO> sugerirAlternativas(String pais, TipoHabitacionDTO tipoHabitacion, GregorianCalendar fechaInicio, GregorianCalendar fechaFin) throws Exception
	{
