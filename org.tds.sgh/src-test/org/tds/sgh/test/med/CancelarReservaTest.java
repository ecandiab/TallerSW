...
public class CancelarReservaTest extends TestBase
{
	...
	public void CancelarReservaCursoTipico() throws Exception
	{
		...
		List<ClienteDTO> clientes2 = cancelarReservaController.buscarCliente(".*lani.*");
		...
		assertTrue("Debe haber una única reserva del cliente.",
		...
		assertTrue("El sistema debe mandar dos mails mail al cliente confirmando la reserva (al registrar y al cancelar).",
				   mails.size() == 2);
