...
public class ModificarReservaTest extends TestBase
{
	...
	public void ModificarReservaCursoTipicoCambioDeTipoHabitacion() throws Exception
	{
		...
		assertTrue("Debe haber disponibilidad ya que es otro tipo de habitación.",
				   disponibilidad);
		...
		assertTrue("El hotel debe tener disponibilidad ya que la reserva que interfería fue modificada.",
				   disponibilidad);
