...
public class buscarClienteTest extends TestBase
{
	...
	public void BuscarClientesNoEsNull()
	{
		...
		assertTrue("El resultado de la búsqueda no debe ser null.",
				   clientes != null);
	}
	...
	public void BuscarClientesEsVacioCuandoNoHayClientesRegistrados()
	{
		...
		assertTrue("La búsqueda no debe devolver clientes ya que no hay clientes registrados.",
				   clientes.isEmpty());
	}
	...
	public void BuscarClientesEsVacioCuandoClientesRegistradosNoCoincidenConElPatron() throws Exception
	{
		...
		assertTrue("La búsqueda no debe devolver clientes ya que los clientes registrados no coinciden con el patrón.",
				   clientes.isEmpty());
	}
	...
	public void BuscarClientesDevuelveTodosLosClientesParaPatronUniversal() throws Exception
	{
		...
		assertTrue("La búsqueda debe devolver todos los dos clientes registrados.",
				   clientes.size() == 3);
	...
	public void BuscarClientesDevuelveSoloLosClientesQueCoincidenConElPatron() throws Exception
	{
		...
		assertTrue("La búsqueda debe devolver los dos clientes registrados que coinciden con el patrón.",
				   clientes.size() == 2);
		
		ClienteDTO clienteX = clientes.get(0);
		ClienteDTO clienteY = clientes.get(1);
		
		assertTrue("La búsqueda debe devolver el cliente1 ya que coincide con el patrón.",
				   cliente1.equals(clienteX) || cliente1.equals(clienteY));

		assertTrue("La búsqueda debe devolver el cliente2 ya que coincide con el patrón.",
	...
	public void BuscarClientesDevuelveUnClienteCuandoElPatronEsExacto() throws Exception
	{
		...
		assertTrue("La búsqueda debe devolver solamente un cliente.",
				   clientes.size() == 1);
		
		assertTrue("La búsqueda debe devolver al cliente2.",
