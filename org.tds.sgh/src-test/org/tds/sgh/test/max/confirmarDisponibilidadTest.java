...
public class confirmarDisponibilidadTest extends TestBase
{
	...
	public void SistemaNoConfirmaDisponibilidadDeHotelInexistente() throws Exception
	{
		...
		GregorianCalendar fechaInicio = generarFecha();
		GregorianCalendar fechaFin = generarFecha(fechaInicio);
	...
	public void NoHayDisponibilidadParaHotelSinHabitacionesDelTipoHabitacion() throws Exception
	{
		...
		assertTrue("El hotel no puede tener disponibilidad ya que no tiene habitaciones del tipo indicado.",
				   !disponibilidad);
	}
	...
	public void NoHayDisponibilidadParaHotelConHabitacionesPeroNoDelTipoHabitacion() throws Exception
	{
		...
		boolean disponibilidad = hacerReservaController.confirmarDisponibilidad(hotel1, tipoHabitacion2, fecha1, fecha2);
	...
	public void HayDisponibilidadParaHotelConHabitacionesDelTipoHabitacionYSinReservas() throws Exception
	{
		...
		assertTrue("El hotel debe tener disponibilidad ya que tiene una habitación del tipo iniciado y no hay reservas registradas.",
				   disponibilidad);
	}
	...
	public void HayDisponibilidadParaHotelConReservasPrevias() throws Exception
	{
		...
		boolean disponibilidad = hacerReservaController1.confirmarDisponibilidad(hotel1, tipoHabitacion1, fecha1, fecha2);
		
		assertTrue("El hotel debe tener disponibilidad ya que no hay reservas registradas.",
				   disponibilidad);
		...
		assertTrue("El hotel debe tener disponibilidad ya que la reserva registrada es previa a las fechas indicadas.",
				   disponibilidad);
	}
	...
	public void HayDisponibilidadParaHotelConReservasPosterioes() throws Exception
	{
		...
		boolean disponibilidad = hacerReservaController1.confirmarDisponibilidad(hotel1, tipoHabitacion1, fecha3, fecha4);
		...
		assertTrue("El hotel debe tener disponibilidad ya que la reserva registrada es posterior a las fechas indicadas.",
				   disponibilidad);
	}
	...
	public void HayDisponibilidadParaHotelConReservasConsecutivas() throws Exception
	{
		...
		assertTrue("El hotel debe tener disponibilidad ya que la reserva registrada termina (check-out) en la fecha de check-in indicado.",
				   disponibilidad);
	}
	...
	public void NoHayDisponibilidadParaHotelConReservasQueInterfiere() throws Exception
	{
		...
		boolean disponibilidad = hacerReservaController1.confirmarDisponibilidad(hotel1, tipoHabitacion1, fecha2, fecha5);
		...
		assertTrue("El hotel no debe tener disponibilidad ya que la reserva registrada interfiere.",
				   !disponibilidad);
